...
<section class="no-results not-found">
	...
	<header class="page-header">
		...
		<h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'digitalclusteruri' ); ?></h1>
	...
	<div class="page-content">
		...
		elseif ( is_search() ) :
			...
			printf(
				'<p>%s<p>',
				esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'digitalclusteruri' )
			);
			get_search_form();
