...
if ( ! function_exists( 'digitalclusteruri_adjust_body_class' ) ) {
	 ...
	 */
	function digitalclusteruri_adjust_body_class( $classes ) {
...
if ( ! function_exists( 'digitalclusteruri_slbd_count_widgets' ) ) {
	/**
	 ...
	 * @deprecated 0.8.9
	 */
	function digitalclusteruri_slbd_count_widgets( $sidebar_id ) {
...
function deprecated_translations() {
	array(
		__( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'digitalclusteruri' ),
		__( 'Previous', 'digitalclusteruri' ),
		__( 'Next', 'digitalclusteruri' ),
		__( 'About:', 'digitalclusteruri' ),
		__( 'Profile', 'digitalclusteruri' ),
		__( 'Posts by', 'digitalclusteruri' ),
		__( 'Permanent Link:', 'digitalclusteruri' ),
		__( 'in', 'digitalclusteruri' ),
		__( 'Edit', 'digitalclusteruri' ),
	);
}
